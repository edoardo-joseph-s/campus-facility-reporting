...
class SemuaLaporanPolicy
{
     ...
     */
    public function forceDelete(User $user, SemuaLaporan $semuaLaporan): bool
    {
     ...
     */
    public function restore(User $user, SemuaLaporan $semuaLaporan): bool
    {
     ...
     */
    public function replicate(User $user, SemuaLaporan $semuaLaporan): bool
    {
